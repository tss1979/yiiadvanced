...
<div class="task-index">
    ...
    <p>
        <?= Html::a('Создать Новое задание', ['create'], ['class' => 'btn btn-success']) ?>
    </p>
      ...
      <?= GridView::widget([
                ...
                'columns' => [
                    ...
                    ['class' => 'yii\grid\ActionColumn',
                        'visibleButtons' => [
                                'update'=> function($searchModel) {
                                            return $searchModel->author_id == Yii::$app->user->identity->id;
                                },
                                'delete'=> function($searchModel) {
                                            return $searchModel->author_id == Yii::$app->user->identity->id;
                                },
                        ]
